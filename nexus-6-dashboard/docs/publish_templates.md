...
* nexus6_template.twbx
* nexus6_compare_template.twbx
* productx_snowflake_costs_template.twbx

In addition, the script provides the following flags to validate items in the Nexus-6 3.0 template (`nexus6_template.twbx`):
...
**NOTE**: These options are supported only for the `nexus6_template.twbx` file.
...
* ```--validate-template```: Flag used to instruct the script to validate the Nexus-6 3.0 template before publishing. This flag is supported only for the nexus6_template.twbx template.
